...
flair_ext = "_flair.nii"
t1ce_ext="_t1ce.nii"
t1_ext = "_t1.nii"
t2_ext = "_t2.nii"

flair,t1ce,t1,t2,preds,gt = get_data_for_plotting(os.path.expanduser(args.data_dir),os.path.expanduser(args.seg_dir),args.mri_id,flair_ext,t1ce_ext,t1_ext,t2_ext,read_labels=args.plot_gt)
...
if(args.plot_gt):
    multi_slice_viewer([
        ...
        {'arr': t1, 'cmap': 'gray', 'stride': 1, 'title': "T1"},
        {'arr': t2, 'cmap': 'gray', 'stride': 1, 'title': "T2"},
