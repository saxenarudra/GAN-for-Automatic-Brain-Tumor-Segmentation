...
mod1,mod2,mod3,mod4,preds,gt = get_data_for_plotting(os.path.expanduser(args.data_dir),os.path.expanduser(args.seg_dir),args.mri_id,flair_ext,t1ce_ext,t1_ext,t2_ext,read_labels=args.plot_gt)
...
horizontal_mod3 = mod3[:,:,hs]
horizontal_mod4 = mod4[:,:,hs]
horizontal_gt = gt[:,:,hs]

coronal_preds = preds[:,cs,:]
coronal_mod1 = mod1[:,cs,:]
coronal_mod2 = mod2[:,cs,:]
coronal_mod3 = mod3[:,cs,:]
coronal_mod4 = mod4[:,cs,:]
coronal_gt = gt[:,cs,:]

saggittal_preds = preds[ss,:,:]
saggittal_mod1 = mod1[ss,:,:]
saggittal_mod2 = mod2[ss,:,:]
saggittal_mod3 = mod1[ss,:,:]
saggittal_mod4 = mod2[ss,:,:]
saggittal_gt = gt[ss,:,:]



if(args.plot_gt):
    fig, axs = plt.subplots(6,3,figsize=(12,6))
    plot_four_on_axis(axs[:,0],horizontal_mod1,horizontal_mod2,horizontal_mod3,horizontal_mod4,horizontal_preds,horizontal_gt)
    plot_four_on_axis(axs[:,1],coronal_mod1,coronal_mod2,coronal_mod3,coronal_mod4,coronal_preds,coronal_gt)
    plot_four_on_axis(axs[:,2],saggittal_mod1,saggittal_mod2,saggittal_mod3,saggittal_mod4,saggittal_preds,saggittal_gt)
